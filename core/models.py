...
class SubscriptionPlan(models.Model):
    ...
    price = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
...
class Customers(SoftDeleteMixin):
    ...
    open_credit = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
    open_debit = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
    otc_credit = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
    ...
    open_balance = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
    otc_balance = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
...
class Purchases(SoftDeleteMixin):
    ...
    client = models.ForeignKey(Clients,on_delete=models.CASCADE,blank=True,null=True)
    seller_balance = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
    purchaser_balance = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
...
class Commissions(SoftDeleteMixin):
    ...
    type = models.TextField(blank=True,null=True)
    client = models.ForeignKey(Clients,on_delete=models.CASCADE,blank=True,null=True)
    godown_balance = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
...
class NSDs(SoftDeleteMixin):
    ...
    code = models.TextField(blank=True,null=True)
    qty = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
    sell_rate = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
    sell_amount = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
    purchase_rate = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
    ...
    type = models.TextField(blank=True,null=True)
    client = models.ForeignKey(Clients,on_delete=models.CASCADE,blank=True,null=True)
    sender_balance = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
    receiver_balance = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
...
class Cashs(SoftDeleteMixin):
    ...
    client = models.ForeignKey(Clients,on_delete=models.CASCADE,blank=True,null=True)
    party_balance = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
...
class CollectionItem(models.Model):
    ...
    amount = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
    collected_amount = models.DecimalField(max_digits=19, decimal_places=4, default=Decimal('0.0000'))
